...
conn.welcome = '*╭─ 〭〭〬〬⿻❥〬〬〬ꦿ[ 𝚂𝙽𝙸𝙿𝙴𝚁 𝙱𝙾𝚃 ] 〭〭〬〬⿻❥〬〬〬ꦿ─╮*\n*│ꪶ→ @subject*\n*│──────────────*\n*│ꪶ→ @user*\n*│ꪶ→ مرحبا انا سنايبر💦🌿✨* \n*│*\n*│ꪶ→ وصف💝 المجموعه:*\n\n@desc\n\n*│*\n*│ꪶ→ واتمنى ان تستمتع معنا بالمجموعه*\n*╰──────────────╯*'
conn.bye = '*╭─ 〭〭〬〬⿻❥〬〬〬ꦿ[ 𝚂𝙽𝙸𝙿𝙴𝚁 𝙱𝙾𝚃 ] 〭〭〬〬⿻❥〬〬〬ꦿ─╮*\n*│ꪶ→ @user*\n*│ꪶ→ غادر المجموعه ⛔*\n*╰──────────────╯*'
...
setInterval(async () => {
  ...
  const bio = `🤖 مده النشاط: ${uptime} ┃ 👑 من صنع  𝚂𝙽𝙸𝙿𝙴𝚁 𝔖 ┃ 🔗 حسابات المطور: https://egsniper.com`;
